...
// ─── enum_constants ───────────────────────────────────────────────────────────
const enum_constants = sequelize.define(
  "enum_constants",
  {
    id: {
...
// ─── unit_infos ───────────────────────────────────────────────────────────────
const unit_infos = sequelize.define(
  "unit_infos",
  {
    ...
    unit_name: {
      ...
      allowNull: false,
      defaultValue: "TRUNG TÂM CÔNG NGHỆ XỬ LÝ BOM MÌN",
    },
    technical_officer: {
      type: DataTypes.STRING(255),
      allowNull: false,
...
const warehouse_images = sequelize.define(
  "warehouse_images",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const warehouse_equipments = sequelize.define(
...
const warehouse_inspections = sequelize.define(
...
const warehouse_accesses = sequelize.define(
  "warehouse_accesses",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const warehouse_handovers = sequelize.define(
  "warehouse_handovers",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const warehouse_exports = sequelize.define(
  "warehouse_exports",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const warehouse_imports = sequelize.define(
  "warehouse_imports",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const warehouse_lightnings = sequelize.define(
...
// ─── weapons ──────────────────────────────────────────────────────────────────
const weapons = sequelize.define(
  "weapons",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const tech_equipments = sequelize.define(
  "tech_equipments",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const staff_warehouses = sequelize.define(
  "staff_warehouses",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const staff_weapons = sequelize.define(
  "staff_weapons",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const staff_vehicles = sequelize.define(
  "staff_vehicles",
  {
    id: {
      type: DataTypes.BIGINT.UNSIGNED,
...
const staff_tech_equipment = sequelize.define(
...
tech_equipments.hasMany(staff_tech_equipment, {
  foreignKey: "tech_equipment_id",
});
staff_tech_equipment.belongsTo(tech_equipments, {
  foreignKey: "tech_equipment_id",
});
